...
app.get("/", (req, res) => {
  ...
  res.render("index.ejs", footerDate);
});
...
app.post("/submit", (req, res) => {
  ...
  let adjName = adj[(Math.floor(Math.random() * adj.length))]
    let nounName = noun[(Math.floor(Math.random() * noun.length))]
  let data = {
    adjName: adj[(Math.floor(Math.random() * adj.length))],
    nounName: noun[(Math.floor(Math.random() * noun.length))],
    fullName: adjName + nounName,
    year: currentYear
  }
